...
<div class="container py-3 py-md-4" style="color: #212529; font-family: system-ui, -apple-system, sans-serif;">
    ...
    <!-- ХЛЕБНЫЕ КРОШКИ (СТРОГИЙ ВЕРХНИЙ РЕГИСТР И МИНИМАЛИЗМ) -->
    ...
    <div class="row g-4 g-md-5">
        ...
        <!-- ЛЕВАЯ КОЛОНКА: ЗОНА ПРЕЗЕНТАЦИИ (ВИЗУАЛ) -->
        <div class="col-12 col-md-6">
            <div class="bg-light-block d-flex align-items-center justify-content-center border border-subtle-gray w-100 position-relative style-neutral" style="aspect-ratio: 4/3; border-radius: 0px !important;">
                ...
                @else
                    <!-- Строгая минималистичная промышленная заглушка -->
        ...
        <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
            ...
            <!-- ИНТЕГРАЦИЯ С БЭКЕНДОМ КОРЗИНЫ -->
            <div class="mb-2">
                <form action="{{ route('cart.add', $product->id) }}" method="POST" class="m-0">
                    @csrf
                    @if($product->stock > 0)
                        <div class="row g-2">
                            <!-- Кнопка фиксации заказа (Хвойно-зеленая, без скруглений) -->
                            <div class="col-12">
                    ...
                    @else
                        <!-- Деактивированное состояние при нулевом остатке -->
    ...
    <div class="mt-5">
        ...
        <div class="row g-4">
            ...
            <!-- Сетка-таблица спецификаций (Чистые линии без коробок) -->
